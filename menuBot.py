...
m_fun = Menu("Развлечения", buttons=["Прислать собаку", "Прислать лису", "Прислать анекдот", "Прислать цитату",  "Прислать новости", "Прислать фильм", "Угадай кто?", "Выход"], parent=m_main, module="fun")
